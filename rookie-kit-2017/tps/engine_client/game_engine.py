...
import logging
from tps.common.game import GameData
from tps.common.object_message import message_to_object
from tps.common.event_message import message_to_event
from tps.common.command_message import *
from tps.common.game_message import *
...
class ClientGameEngine:
    ...
    def process_server_message(self, msg):
        ...
        if obj is not None:
            self.logger.debug('update_object:(%s)', obj)
            ...
            if code == M_PLAYER_OID:
                ...
                if (not msg.get_request()) and msg.get_result():
                    ...
                    self.logger.error("Unknown login message: %s", msg)
